...
async function carregarFuncionarios() {
    try {
        ...
        if (!Array.isArray(funcionarios)) {
            alert((funcionarios.message || "Erro ao listar funcionários") + "\n" + (funcionarios.erro || ""));
            return;
        }
        ...
        if (!Array.isArray(pontos)) {
            alert((pontos.message || "Erro ao listar pontos") + "\n" + (pontos.erro || ""));
            return;
        }
        ...
        funcionarios.forEach(funcionario => {
            ...
            lista.innerHTML += `
                <div class="card-funcionario card-resumo-ponto">
                    ...
                    <div class="dados-funcionario-ponto">
                    ...
                    <button class="btn-abrir-ponto" onclick="window.location.href='ponto_funcionario.php?id=${funcionario.id}'">
                        Abrir ponto
                    </button>
        ...
        console.error(error);
        alert("Erro ao carregar funcionários e resumo de ponto.");
    }
}
